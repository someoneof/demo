...
function HideAll(){
    ...
    for (var i=0; i<tables.length; i++) {
		...
		if(imgId) imgId.src=" ${pageContext.request.contextPath}/images/midclosedfolder.gif";
		if(imgId2) imgId2.src=" ${pageContext.request.contextPath}/images/clsfld.gif";
	}
}
...
function turnit(id) {
	...
	if (menu.style.display=="none"){
		HideAll();
		menu.style.display = "";
		if(imgId) imgId.src=" ${pageContext.request.contextPath}/images/midopenedfolder.gif";
		if(imgId2) imgId2.src=" ${pageContext.request.contextPath}/images/openfld.gif";
	}else{
...
<table border=0 width="98%" align="center" cellspacing="0" cellpadding="0">
  <tr> 
    <td colspan="3" language="JavaScript" onMouseUp="turnit('order')" style="CURSOR: hand"> 
      <img id="Imgorder" src=" ${pageContext.request.contextPath}/images/midclosedfolder.gif" align="absMiddle" border="0" width="16"><img name="Imgorder_0" src=" ${pageContext.request.contextPath}/images/clsfld.gif" align="absMiddle" border="0"> 
...
<table id="menu_order" border=0 width="98%" align="center" cellspacing="0" cellpadding="0" style="display:none">
  <tr> 
    <td width="50"><img src=" ${pageContext.request.contextPath}/images/vertline.gif" border=0><img src=" ${pageContext.request.contextPath}/images/lastnodeline.gif" align="absMiddle" border=0 width="16" height="22"><img src=" ${pageContext.request.contextPath}/images/doctemp.gif" align="absMiddle" border="0" width="16" height="16"></td>
...
<table border=0 width="98%" align="center" cellspacing="0" cellpadding="0">
  <tr> 
    <td colspan="3" language="JavaScript" onMouseUp="turnit('Product')" style="CURSOR: hand"> 
      <img id="ImgProduct" src=" ${pageContext.request.contextPath}/images/midclosedfolder.gif" align="absMiddle" border="0" width="16"><img name="ImgProduct_0" src=" ${pageContext.request.contextPath}/images/clsfld.gif" align="absMiddle" border="0"> 
...
<table border=0 width="98%" align="center" cellspacing="0" cellpadding="0">
  <tr> 
    <td colspan="3" language="JavaScript" onMouseUp="turnit('file')" style="CURSOR: hand"> 
      <img id="Imgfile" src=" ${pageContext.request.contextPath}/images/midclosedfolder.gif" align="absMiddle" border="0" width="16"><img name="Imgfile_0" src=" ${pageContext.request.contextPath}/images/clsfld.gif" align="absMiddle" border="0"> 
...
<table border=0 width="98%" align="center" cellspacing="0" cellpadding="0">
  <tr> 
    <td colspan="3" language="JavaScript" onMouseUp="turnit('user')" style="CURSOR: hand"> 
      <img id="Imguser" src=" ${pageContext.request.contextPath}/images/midclosedfolder.gif" align="absMiddle" border="0" width="16"><img name="Imguser_0" src=" ${pageContext.request.contextPath}/images/clsfld.gif" align="absMiddle" border="0"> 
...
<table border=0 width="98%" align="center" cellspacing="0" cellpadding="0">
  <tr> 
    <td colspan="3" language="JavaScript" onMouseUp="turnit('department')" style="CURSOR: hand"> 
      <img id="Imgdepartment" src=" ${pageContext.request.contextPath}/images/midclosedfolder.gif" align="absMiddle" border="0" width="16"><img name="Imgdepartment_0" src=" ${pageContext.request.contextPath}/images/clsfld.gif" align="absMiddle" border="0"> 
...
<table border="0" width="98%" align="center" cellspacing="0" cellpadding="0">
  <tr> 
    <td width="20"><img src=" ${pageContext.request.contextPath}/images/lastnodeline.gif" border="0"></td>
    <td>
